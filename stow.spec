...
Version  : 2.4.0
Release  : 25
URL      : https://mirrors.kernel.org/gnu/stow/stow-2.4.0.tar.gz
Source0  : https://mirrors.kernel.org/gnu/stow/stow-2.4.0.tar.gz
Source1  : https://mirrors.kernel.org/gnu/stow/stow-2.4.0.tar.gz.sig
...
%setup -q -n stow-2.4.0
cd %{_builddir}/stow-2.4.0
%patch -P 1 -p1
pushd ..
cp -a stow-2.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720028609
